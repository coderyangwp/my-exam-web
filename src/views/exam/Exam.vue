    ...
    <el-row :gutter="20">
      ...
      <el-col :span="10">
        <el-card>
          ...
          <div v-else class="my-code">点击考试查看考试安排</div>
        </el-card>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="24">
        <el-card>
          ...
          <el-collapse v-if="Object.keys(currentExam).length > 0" accordion>
          ...
          <div v-else class="my-code">点击考试查看考试科目</div>
        </el-card>
      </el-col>
    </el-row>
    <exam-dialog :examInfo="examDialog" @closeExamDialog="handlerCloseDialog"></exam-dialog>
    <exam-course :courseInfo="examCourseDialog"  @closeExamCourse="handlerCloseCourse"></exam-course>
  </div>
</template>
