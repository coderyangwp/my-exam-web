  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <el-form-item prop="username">
        <el-input ref="account" v-model="loginForm.username" placeholder="用户名" name="username" type="text" tabindex="1"
          auto-complete="on" prefix-icon="icon-yonghu" clearable />
      </el-form-item>

      <el-form-item prop="password">
        <el-input :key="passwordType" ref="password" v-model="loginForm.password" :type="passwordType" placeholder="密码"
          name="password" tabindex="2" auto-complete="on" show-password prefix-icon="icon-mima" clearable
          @keyup.enter.native="handleLogin" />
      </el-form-item>
      <el-form-item prop="captcha">
        <el-input ref="captcha" v-model="loginForm.captcha" placeholder="验证码" style="width: 69%"
          prefix-icon="icon-yanzhengma" clearable />
        ...
        this.$refs.loginForm.validate((valid) => {
          if (valid) {
            ...
            this.$store
              ...
              .then(() => {
                //防止重新登陆后直接跳转到404页面
                this.redirect = this.redirect === '/404' ? '/dashboard' : this.redirect
