<template>
  <div class="app-container">
    <el-row class="generator-table-list">
      <el-col>
        <el-input v-model="queryParams.tableName" placeholder="请输入表名" size="small" clearable />
    ...
    <el-row>
      <el-col :span="24">
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="tableCollation" label="字符编码集" />
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              <el-button type="text" @click="preview(scope.row.tableName)">预览</el-button>
              <el-button type="text" @click="downloadCode(scope.row.tableName)">下载</el-button>
              <el-button type="text">生成</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination class="fr pagination-container" background layout="prev, pager, next, total" :total="total"
          :page-size="queryParams.size" :current-page="queryParams.current" @current-change="handleCurrentChange">
...
<script>
  import { tableList, downLoad, downloadFile } from '@/api/systool'
